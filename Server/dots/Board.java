...
public class Board {
	 ...
	 * @param row :largo 
	 * @param column : ancho
	 * se crear� del tama�o que se le indique.
	 */
	 ...
	 * @param x : posicion seg�n el fila.
	 * @param y : posicion seg�n la columna
	 ...
	 * @param x : posicion seg�n el raw.
	 * @param y : posicion seg�n la column
	 */
